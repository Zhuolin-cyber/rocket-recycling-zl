...
H = 15.0              # tank height (m)
fuel_mass_5percent = 5400  # kg
fuel_mass = 5400 * 20  # kg
...
# 保存路径
save_dir = "./LUT_output_FU"
os.makedirs(save_dir, exist_ok=True)

# 保存两个重心表
np.save(os.path.join(save_dir, "FU_LUT_xc.npy"), LUT_xc)
np.save(os.path.join(save_dir, "FU_LUT_zc.npy"), LUT_zc)

np.savetxt(os.path.join(save_dir, "FU_LUT_xc.csv"), LUT_xc, delimiter=",")
np.savetxt(os.path.join(save_dir, "FU_LUT_zc.csv"), LUT_zc, delimiter=",")
